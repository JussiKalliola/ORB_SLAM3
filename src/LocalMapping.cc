...
void LocalMapping::Run()
{
    ...
    while(1)
    {
        ...
        {
            //std::cout << "  Thread2=LocalMapping::Run : Stop()" << std::endl;
            // Safe area to stop
        ...
        if(mbKFsAfterMapUpdate || mbLocalMappingDone || mpCurrentKeyFrame)//if(mpCurrentKeyFrame)
        {
        ...
        //std::cout << "  Thread2=LocalMapping::Run : End of the loop, sleep(3000)" << std::endl;
        usleep(3000);
    }
...
bool LocalMapping::NeedNewKeyFrame(KeyFrame* pKF)
{
    ...
    std::cout << "before get map kfs in map" << std::endl;
